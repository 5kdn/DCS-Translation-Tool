...
using System;
namespace DcsTranslationTool.Infrastructure.Http.ApiClient.Health
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthGetResponse?> GetAsHealthGetResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthGetResponse> GetAsHealthGetResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthRequestBuilder WithUrl(string rawUrl)
        {
            return new global::DcsTranslationTool.Infrastructure.Http.ApiClient.Health.HealthRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
